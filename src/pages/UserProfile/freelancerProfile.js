  ...
  const navigate = useNavigate();
    ...
    return(
        ...
        <div className="search-title align-items-center ">
                  <h1 className='page-title mt-5 ms-4'>Better market your expertise with specialized profiles</h1>
                  <p className='profile-description mt-5 ms-4 me-5'>Specialized profiles allow you to display more specific skills, deliverables, and more – and help power better search results and job recommendations. Learn more</p>
                  <div className="form-action text-center m-5">
                <Button type="button" className="btn-round me-5 btn-submit p -3 w-50 align-items-right justify-items-right"> Create a Specialized Profile </Button>
            </div>
        ...
        <div className="d-flex flex-row mt-5  border-bottom  border-$grey2-100 rounded  pb-5">
            <div className="d-flex flex-row w-50 ms-5  ">
                <img src={profileDetail.profilePictureUrl} alt='dp' className='rounded-circle me-5 ' id='profile-circle'/>
            ...
            <div className="form-action text-center m-5 pt-5 ps-5">
                <Button type="button" className="btn-round me-5 btn-submit p -3 w-100 "> Public View </Button>
            </div>
            <div className="form-action text-center m-5 pt-5"><Button type="submit" className="btn-round btn-submit p -3 w-100" onClick={updateProfile}> Profile Settings </Button></div>
        </div>

        <div className="d-flex flex-row">
        <div className='border-left border-dark ms-5 rounded '>
            <h2 className='mb-3'>Rate per hour <TbEdit className="heart-icon" /></h2>
            <p className="profile-description">  {profileDetail?.hourlyRate}$ per hour </p >
            ...
            <h4 className="profile-description"> {profileDetail?.educationDetails[0].schoolName}</h4 >
            <p className="profile-description">{profileDetail?.educationDetails[0].degree}
            </p >
            <p className="profile-description">
            {profileDetail?.educationDetails[0].studyField}</p >
            <h6  className='mb-5'>
            {profileDetail?.educationDetails[0].attendedDate} to {profileDetail?.educationDetails[0].endDate} </h6 >
        </div>
        <div className='me-5 ms-5 ps-5 border-right border-success  '>
            ...
            <h4 className="profile-description" >{profileDetail?.workExperiences[0].workTitle}  |{' '}
            ...
            {profileDetail?.workExperiences[0].workStartDate} - {' '} {profileDetail?.workExperiences[0].workEndDate}</h6 >

            <div className='border-bottom  border-$grey2-100 rounded'></div>

            <h1 className='mt-5'>Skills  <IoMdAddCircleOutline className="heart-icon" /> </h1>
            <p className="profile-description" >
            {profileDetail?.skills}</p >
